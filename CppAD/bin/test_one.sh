...
if [ 1 ==  '1' ]
then
   cppad_lib_path='/home/xbl/Desktop/all/CppAD/build/cppad_lib/libcppad_lib.so'
else
   cppad_lib_path='/home/xbl/Desktop/all/CppAD/build/cppad_lib/libcppad_lib.a'
fi
...
# --------------------------------------------------------------------------
# LD_LIBRARY_PATH
my_path='/home/xbl/Desktop/all/CppAD/build/cppad_lib'
if ! echo $LD_LIBRARY_PATH | grep "$my_path" > /dev/null
then
   if [ "$LD_LIBRARY_PATH" == '' ]
   then
